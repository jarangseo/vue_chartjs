<template>
    <div>
        <h1>Pie Chart</h1>
        <canvas id="pieChart" ref="pieChart" width="400" height="400"></canvas>
    </div>
</template>
<script>
...
export default {
    ...
    mounted() {
    var that = this;
    var pieChart = new this.$_Chart(this.$refs.pieChart.getContext('2d'), {
      type: 'pie',
      data: {
